...
- [ ] 🔴 **BLOQ** — Botão "Gerenciar análises do pacote" presente no header do HTML
- [ ] 🔴 **BLOQ** — Mapa-mestre lista **todas** as análises do pacote (Preliminar + Adicional + Validada)
- [ ] 🔴 **BLOQ** — Toggle de 3 estados funcional em cada linha (clique muda estado, propaga pros agregados)
...
- [ ] 🔴 **BLOQ** — Botões funcionais: "Salvar como HTML", "Resetar para original", "Exportar JSON", "Gerenciar análises"
- [ ] 🔴 **BLOQ** — `localStorage` salva edições com debounce 500ms; ao recarregar, restaura estado
